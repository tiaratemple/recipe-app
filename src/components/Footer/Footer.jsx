        ...
        <div className="link-container">
          <a href="https://www.devmountain.com" target="_blank">
            <div className="link-styles">
              <ImFacebook size="1.5em" className="footer-icon-styles"/>
            </div>
          </a>
          <a href="https://www.devmountain.com" target="_blank">
            <div className="link-styles">
              <ImInstagram size="1.5em" className="footer-icon-styles" />
            </div>
          </a>
          <a href="https://www.devmountain.com" target="_blank">
            <div className="link-styles">
              <ImTwitter size="1.5em" className="footer-icon-styles" />
            </div>
          </a>
          <a href="https://www.devmountain.com" target="_blank">
            <div className="link-styles">
              <ImGithub size="1.5em" className="footer-icon-styles" />
            </div>
          </a>
        </div>
      </div>
